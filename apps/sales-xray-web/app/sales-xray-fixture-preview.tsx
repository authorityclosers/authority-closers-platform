      ...
      >
        <div className="studio-main">
          ...
          >
            ...
            <div
              className={previewStyles.modeSwitch}
              role="group"
              aria-label="Number of preview files"
            >
              <button
                type="button"
          ...
          <div className={styles.layout}>
            <div className={styles.primaryColumn}>
              <section
                className={`panel studio-upload ${styles.upload} ${previewStyles.selectedCard}`}
    ...
    >
      ...
      >
        <div className="studio-main">
          <nav
            className={`${styles.reviewNotice} ${previewStyles.navigation}`}
            aria-label="Fixture state navigation"
          >
            <div>
              <strong>{frame.label}</strong>
              <small>
                Local test state {frame.navigation.position} of{" "}
                {frame.navigation.total}. Synthetic display only; no call or
                report exists.
              </small>
            </div>
