...
REQUIRED_ASSERTIONS = {
    ...
    "the same selected browser File uploads after profile completion",
...
def _load_browser_receipt(path: Path, build_id: str) -> dict[str, Any]:
    ...
    required_journey = {
        ...
        "same_file_retained_in_auth_modal": True,
        "same_file_retained_through_profile": True,
        "same_file_retained_for_upload": True,
