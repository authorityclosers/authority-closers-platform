...
_COACH_ROUTES = tuple(
    ...
    for method, path in (
        ...
        ("POST", r"/v1/admin/studio/programs"),
        ("GET", rf"/v1/admin/studio/programs/{_UUID}"),
        ("GET", rf"/v1/admin/studio/programs/{_UUID}/videos"),
        (
            "GET",
            rf"/v1/admin/studio/programs/{_UUID}/videos/{_UUID}/versions/{_UUID}/preview",
        ),
        (
            "GET",
            rf"/v1/admin/studio/programs/{_UUID}/videos/{_UUID}/versions/{_UUID}/preview/bytes",
        ),
        (
            "HEAD",
            rf"/v1/admin/studio/programs/{_UUID}/videos/{_UUID}/versions/{_UUID}/preview/bytes",
        ),
        ("GET", rf"/v1/admin/studio/programs/{_UUID}/video-upload-capability"),
        ("POST", rf"/v1/admin/studio/programs/{_UUID}/video-uploads"),
        ("GET", rf"/v1/admin/studio/programs/{_UUID}/video-uploads/{_UUID}"),
        ("PUT", rf"/v1/admin/studio/programs/{_UUID}/video-uploads/{_UUID}/bytes"),
        ("POST", rf"/v1/admin/studio/programs/{_UUID}/video-uploads/{_UUID}/complete"),
        ("GET", rf"/v1/admin/studio/programs/{_UUID}/activities/{_UUID}/video"),
        ("POST", rf"/v1/admin/studio/programs/{_UUID}/activities/{_UUID}/video"),
