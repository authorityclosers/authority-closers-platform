...
| Learner Google registration          | consent-gated browser start, signed consent-version binding, verified-provider persistence, public learner provisioning, and focused unit/API/PostgreSQL/browser regressions | LOCAL VERIFIED; STAGING PENDING |
