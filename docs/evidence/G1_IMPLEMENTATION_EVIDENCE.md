...
| Learner Google registration          | consent-gated browser start, signed consent-version binding, verified-provider persistence, public learner provisioning, allowlisted same-origin callback recovery, focused unit/API/PostgreSQL/browser regressions, and exact-release desktop/mobile staging captures | STAGING VERIFIED; FINAL REAL-ACCOUNT RE-CONSENT OPEN |
...
| Edge/application release             | same-origin `/v1` routing, pinned Caddy validation, immutable release `81635d18569c06962af37c1fa64d0d5814d0f2bf`, and public staging learner/API/Admin Access smoke                                                                                                    | PASS (staging)                                       |
