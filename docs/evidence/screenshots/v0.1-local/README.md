...
Historical pack: this 32-image set records the pre-Clarity visual baseline.
The current Drive-aligned auth/onboarding/learner-state/admin captures are in
[`../v0.1-drive-aligned/README.md`](../v0.1-drive-aligned/README.md). Keep this
pack for comparison; do not present it as the current UI.
