...
This contract describes the current repository implementation. It is not a
blanket staging-deployment claim: deployment and route acceptance remain
scoped to the immutable releases and evidence records named in the status
register.
